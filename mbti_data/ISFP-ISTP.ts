{
  "ISTP": {
    ...
    provider: "ISTP",
    summary: {
      en: "ISFPs and ISTPs share a practical, hands-on approach to life but differ in their core motivations. Both types value autonomy and live in the present moment, creating a relaxed dynamic. ISFPs bring emotional depth while ISTPs offer logical problem-solving, forming a complementary partnership where both can learn from each other's strengths.",
      zh: "ISFP和ISTP都注重实际和动手能力，但核心动机不同。两种类型都重视自主性并活在当下，形成轻松的关系动态。ISFP带来情感深度，ISTP提供逻辑问题解决能力，形成互补关系，双方都能从对方的优势中学习。"
    },
    relationshipType: {
    ...
    relationshipDesc: {
      en: "A low-pressure bond built on shared experiences and mutual respect for independence.",
      zh: "建立在共同经历和对独立性相互尊重基础上的轻松关系。"
    },
    sharedValues: {
    ...
    sharedValuesDesc: {
      en: "Both highly value personal freedom and being true to themselves, disliking artificial constraints.",
      zh: "双方都非常重视个人自由和忠于自我，不喜欢人为的约束。"
    },
    communicationStyle: {
      en: "Action-Oriented",
      zh: "行动导向"
    ...
    communicationDesc: {
      en: "Prefer doing over talking, communicating through shared activities rather than lengthy discussions.",
      zh: "更喜欢行动而非空谈，通过共同活动而非冗长讨论来交流。"
    },
    cognitiveCompatibility: {
      "Fi_Se": {
        ...
        description: {
          en: "ISFP's strong values align well with ISTP's sensory awareness, creating harmony in shared experiences.",
          zh: "ISFP的强烈价值观与ISTP的感官意识相契合，在共同体验中创造和谐。"
        }
      },
      "Se_Se": {
        score: 95,
        ...
        type2Function: "Se (Auxiliary)",
        description: {
          en: "Shared Se creates immediate understanding and enjoyment of sensory experiences together.",
          zh: "共同的Se功能使双方能立即理解并享受感官体验。"
        }
      },
      "Ni_Ti": {
        score: 75,
        ...
        description: {
          en: "ISTP's logical analysis can help ground ISFP's occasional intuitive leaps in reality.",
          zh: "ISTP的逻辑分析可以帮助ISFP将偶尔的直觉跳跃与现实联系起来。"
        }
      },
      "Te_Fe": {
        score: 65,
        ...
        description: {
          en: "Both struggle with external systems and emotional expression, potentially causing minor misunderstandings.",
          zh: "双方都对外部系统和情感表达感到困难，可能导致小误会。"
        }
      }
    },
    compatibilityReason: {
      en: "Their compatibility stems from shared Se function that creates natural understanding, while their differing dominant functions (Fi vs Ti) provide complementary perspectives. Both value independence and direct experience over abstract theory.",
      zh: "他们的兼容性源于共同的Se功能创造的自然理解，而不同的主导功能(Fi vs Ti)提供了互补的视角。双方都重视独立性和直接体验而非抽象理论。"
    },
    growthPotential: {
      en: "ISFPs can learn logical consistency from ISTPs, while ISTPs can develop emotional awareness from ISFPs. Both may struggle with long-term planning but can motivate each other's inferior functions.",
      zh: "ISFP可以从ISTP那里学习逻辑一致性，而ISTP可以从ISFP那里发展情感意识。双方可能在长期规划上有困难，但可以激励彼此的劣势功能。"
    },
    faq: [
      {
        question: {
          en: "How do ISFP and ISTP handle conflicts?",
          zh: "ISFP和ISTP如何处理冲突？"
        },
        answer: {
          en: "Both tend to avoid direct confrontation initially. ISFPs may withdraw emotionally while ISTPs analyze the problem logically before reconnecting.",
          zh: "双方最初都倾向于避免直接对抗。ISFP可能在情感上退缩，而ISTP会先逻辑分析问题，然后重新连接。"
        }
      }
    ]
  }
